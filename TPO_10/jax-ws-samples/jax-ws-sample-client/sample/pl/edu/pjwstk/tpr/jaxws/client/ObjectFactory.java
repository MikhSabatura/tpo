...
public class ObjectFactory {
    ...
    private final static QName _Subtract_QNAME = new QName("http://jaxws.tpr.pjwstk.edu.pl/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://jaxws.tpr.pjwstk.edu.pl/", "subtractResponse");
    private final static QName _AddResponse_QNAME = new QName("http://jaxws.tpr.pjwstk.edu.pl/", "addResponse");
    private final static QName _Add_QNAME = new QName("http://jaxws.tpr.pjwstk.edu.pl/", "add");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.tpr.pjwstk.edu.pl/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.tpr.pjwstk.edu.pl/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.tpr.pjwstk.edu.pl/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.tpr.pjwstk.edu.pl/", name = "add")
