 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://jaxws.tpr.pjwstk.edu.pl/", wsdlLocation = "http://localhost:8080/jax-ws-sample/calculator?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/jax-ws-sample/calculator?wsdl");
