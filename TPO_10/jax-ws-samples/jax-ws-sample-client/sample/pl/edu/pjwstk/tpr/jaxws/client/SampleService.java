 ...
 * 
 */
@WebServiceClient(name = "SampleService", targetNamespace = "http://jaxws.tpr.pjwstk.edu.pl/", wsdlLocation = "http://localhost:8080/jax-ws-sample/sample?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/jax-ws-sample/sample?wsdl");
