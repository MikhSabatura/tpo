 ...
 * 
 */
@WebServiceClient(name = "CalculatorDelayedService", targetNamespace = "http://delayed.jaxws.tpr.pjwstk.edu.pl/", wsdlLocation = "http://localhost:8080/jax-ws-sample/calculator-delayed?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/jax-ws-sample/calculator-delayed?wsdl");
