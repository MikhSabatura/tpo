 ...
 * 
 */
@WebServiceClient(name = "BigDataStandardService", targetNamespace = "http://mtom.jaxws.tpr.pjwstk.edu.pl/", wsdlLocation = "http://localhost:8080/jax-ws-sample/big-data-standard?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/jax-ws-sample/big-data-standard?wsdl");
